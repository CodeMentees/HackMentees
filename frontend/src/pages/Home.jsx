      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl sm:text-2xl lg:text-3xl mb-12 text-muted-foreground dark:text-gray-300 max-w-4xl mx-auto leading-relaxed">
            A{" "}
            <span className="font-semibold text-primary">beginner-friendly</span>{" "}
            hub for
        ...
        <div className="container mx-auto text-center relative">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl sm:text-2xl mb-12 opacity-90 max-w-3xl mx-auto leading-relaxed">
              Join our community of developers and make your mark in the world
              of open source. Whether you're a seasoned developer or just
              starting out, we have opportunities for everyone.
            </p>
        ...
        <div className="container mx-auto">
          <div className="text-center">
            ...
            <p className="text-muted-foreground text-sm">
              &copy; 2025 HackMentees. Open source project for Hacktoberfest
              contributors.
            </p>
          </div>
        </div>
